...
class ApiUserAchievementsRebuildAchievement extends ApiUserAchievementsBasePost {
    ...
    public function execute() {
        ...
        foreach( $achievements as $achievement ) {
            if( $params[ 'purgeuserbadges' ] ) {
                $achievement->purgeUserBadges();
            }

            if( !$achievement->rebuildAchievement() ) {
                $output[ $uaaction ][ 'status' ] = 'error';
            }
        }
